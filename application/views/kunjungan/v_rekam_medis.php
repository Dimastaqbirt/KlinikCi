                            ...
                            <table class="table table-sm table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?= tanggal_indo($r['tgl_rekam_medis']);?>
                                        </td>
                                        <td>
                                        <?= $r['keluhan'] ;?>
                                        </td>
            ...
            <div class="card border-danger  mb-3 ">   
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-1">
                            ...
                            <textarea name="diagnosa" class="form-control d-flex" cols="65" value="<?= $r['hasil_diagnosa'] ;?>"><?= $d['hasil_diagnosa'] ;?></textarea required>
                        </div>
                        <div class="form-group mb-1">
                            <label for="">Penatalaksanaan</label>
                            <select name="penatalaksanaan" required class="form-control d-flex" >
                            <?php if($d['id_rekam_medis']==$r['id_rekam_medis']){
                                $aktif ='selected';
                            } else {
                                $aktif = '';
                            };?>
                                <option value="<?= $r['penatalaksanaan'] ;?>" <?= $aktif ;?>><?= $r['penatalaksanaan'] ;?></option>
                        ...
                        <div class="form-group mb-1">
                            ...
                            <textarea name="keterangan" class="form-control d-flex" cols="65" value="<?= $r['keterangan'] ;?>"><?= $r['keterangan'] ;?></textarea required>
                        </div>
